...
CUDA_VERSOIN=11.0
CUDNN_VERSOIN=8.0.5
CUDA_FILE=cuda_11.0.3_450.51.06_linux.run
CUDNN_FILE=cudnn-11.0-linux-x64-v8.0.5.39.tgz
CUDA_URI=https://developer.download.nvidia.com/compute/cuda/11.0.3/local_installers/cuda_11.0.3_450.51.06_linux.run
